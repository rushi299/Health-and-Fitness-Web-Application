...
<body>
  <section id="hero">
    ...
    <h1 id="h1heading">yoga warm up  </h1>
    <hr>
    <div class="packs">
        <div class="video">

            <iframe width="560" height="315" src="https://www.youtube.com/embed/ftLAgXeOJ8k" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
